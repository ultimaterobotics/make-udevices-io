...
![Android app screenshot](../../../assets/app-screenshot.png)

1. Find your PC's local IP address (`ip addr` on Linux, `ipconfig` on Windows)
2. Download the APK from the [v0.1.0 release](https://github.com/ultimaterobotics/umyo-android/releases/tag/v0.1.0) and install it on your Android device. Enable "Install from unknown sources" in developer options if prompted.
...
:::tip
If the workbench doesn't receive data, you may need to allow port 26750 in your firewall. On Linux with ufw: `sudo ufw allow 26750`. If you get stuck, ask in [Discord](https://discord.com/invite/dEmCPBzv9G).
:::
